...
<?php $bg = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), 'full' );?>
            ...
            <form action="" method="get" class="bg-primary py-5"  style="background: url('<?php // echo $bg[0]; ?>') no-repeat; background-size: cover;">
                <div class="card-body row no-gutters align-items-center">
                            ...
                            ?> 
                            <!--<div class="px-4"><a class="btn btn-primary btn-block" href="minasidorbeta.gavleenergi.se' ); ?>">Logga in på Mina sidor</a></div>-->
                        </nav>
                        <div id="content">